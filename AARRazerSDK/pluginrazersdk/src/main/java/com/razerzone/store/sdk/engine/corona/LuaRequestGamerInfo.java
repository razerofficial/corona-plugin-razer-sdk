...
public class LuaRequestGamerInfo implements NamedJavaFunction {

    public static final String TAG = LuaRequestGamerInfo.class.getSimpleName();

	public String getName() {
		return "RequestGamerInfo";
	}
	...
	public int invoke(LuaState luaState) {
		...
		// store for access
		Plugin.setCallbacksRequestGamerInfo(callbacks);
