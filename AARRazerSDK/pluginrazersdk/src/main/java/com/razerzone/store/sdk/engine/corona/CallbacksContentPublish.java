...
public class CallbacksContentPublish {
	...
	public void CallbacksContentPublishOnError(GameMod gameMod, int code, String reason, Bundle bundle) { }
	public void CallbacksContentPublishOnSuccess(GameMod gameMod) { }
