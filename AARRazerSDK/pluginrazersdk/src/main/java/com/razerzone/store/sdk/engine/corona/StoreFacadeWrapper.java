...
public class StoreFacadeWrapper
{
	...
	public void shutdown() {
		...
		if (null == mStoreFacade) {
            ...
            try {
                ...
                e.printStackTrace();
                mShutdownListener.onFailure(0, "Shutdown exception occurred!", null);
            }
		}
	}
	...
	public void contentUnpublish(final GameMod gameMod) {
		if (null == mUnpublishListener) {
			Log.e(TAG, "contentUnpublish: mUnpublishListener is null");
		} else {
	...
	public void contentDownload(final GameMod gameMod) {
		if (null == mDownloadListener) {
			Log.e(TAG, "contentDownload: mDownloadListener is null");
		} else {
	...
	public String getDeviceHardwareName() {
		if (null == mStoreFacade) {
			Log.e(TAG, "getDeviceHardwareName: StoreFacade is null!");
			return "";
		}
		StoreFacade.DeviceHardware deviceHardware = mStoreFacade.getDeviceHardware();
		if (null == deviceHardware) {
			Log.e(TAG, "getDeviceHardwareName: DeviceHardware is null!");
			return "";
		}
