...
public class CallbacksContentSearchPublished {
	...
	public void CallbacksContentSearchPublishedOnError(int code, String reason) { }
	public void CallbacksContentSearchPublishedOnResults(GameMod[] gameMods, int count) { }
