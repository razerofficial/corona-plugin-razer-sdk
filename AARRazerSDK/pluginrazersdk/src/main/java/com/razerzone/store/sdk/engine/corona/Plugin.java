...
public class Plugin
{
	...
	private static CallbacksRequestReceipts sCallbacksRequestReceipts = null;
    private static CallbacksShutdown sCallbacksShutdown = null;
	...
	public static void setCallbacksInitPlugin(CallbacksInitPlugin callback) { sCallbacksInitPlugin = callback; }
	...
	public static void setCallbacksRequestProducts(CallbacksRequestProducts callback) { sCallbacksRequestProducts = callback; }

	public static CallbacksRequestPurchase getCallbacksRequestPurchase() { return sCallbacksRequestPurchase; }
	public static void setCallbacksRequestPurchase(CallbacksRequestPurchase callback) { sCallbacksRequestPurchase = callback; }

	public static CallbacksRequestReceipts getCallbacksRequestReceipts() { return sCallbacksRequestReceipts; }
	public static void setCallbacksRequestReceipts(CallbacksRequestReceipts callback) { sCallbacksRequestReceipts = callback; }

    public static CallbacksShutdown getCallbacksShutdown() { return sCallbacksShutdown; }
	public static void setCallbacksShutdown(CallbacksShutdown callback) { sCallbacksShutdown = callback; }
