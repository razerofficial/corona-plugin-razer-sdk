...
public class CallbacksContentSearchInstalled {
	...
	public void CallbacksContentSearchInstalledOnError(int code, String reason) { }
	public void CallbacksContentSearchInstalledOnResults(GameMod[] gameMods, int count) { }
