...
public class LuaRequestPurchase implements NamedJavaFunction {
	/**
	...
	public int invoke(LuaState luaState) {
		...
		// store for access
		Plugin.setCallbacksRequestPurchase(callbacks);
		
		// invoke service
		Plugin.requestPurchase(callbacks.mIdentifier, callbacks.mProductType);
