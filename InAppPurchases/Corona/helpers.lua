...
helpers.createButton = function (x, y, xScale, yScale, id, text, tx, ty, ts)
	...
	button.spriteActive.id = id;
	button.spriteActive.parent = button;
	button.spriteInactive.id = id;
	button.spriteInactive.parent = button;
	...
	button.spriteActive:addEventListener( "touch", ui.onObjectTouch );
	button.spriteInactive:addEventListener( "touch", ui.onObjectTouch );
