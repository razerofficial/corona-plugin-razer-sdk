...
callbacksRequestProducts.onSuccess = function (jsonData)
	ui.txtStatus.text = "onSuccessRequestProducts";
...
callbacksRequestProducts.onFailure = function (errorCode, errorMessage)
	...
	local msg = "onFailureRequestProducts: errorCode=" .. errorCode .. " errorMessage=" .. errorMessage;
	print(msg);
	ui.txtStatus.text = msg;
end

callbacksRequestProducts.onCancel = function ()
	ui.txtStatus.text = "onCancelRequestProducts";
